...
describe("RegisterForm", () => {
  ...
  it("renders registration form with all fields", () => {
    ...
    expect(
      screen.getByText("auth.register.confirmPassword"),
    ).toBeInTheDocument();
  });
  ...
  it("renders all input placeholders", () => {
    ...
    expect(
      screen.getByPlaceholderText("auth.register.usernamePlaceholder"),
    ).toBeInTheDocument();
    expect(
    ...
    expect(
      screen.getByPlaceholderText("auth.register.confirmPasswordPlaceholder"),
    ).toBeInTheDocument();
  });

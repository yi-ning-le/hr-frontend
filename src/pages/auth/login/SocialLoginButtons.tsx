      ...
      <div className="grid grid-cols-3 gap-3">
        ...
        >
          <svg
            ...
            aria-labelledby="wechat-icon-title"
            role="img"
          >
            <title id="wechat-icon-title">{t("auth.social.wechat")}</title>
        ...
        >
          <svg
            ...
            fill="currentColor"
            xmlns="http://www.w3.org/2000/svg"
            aria-labelledby="dingtalk-icon-title"
            role="img"
          >
            <title id="dingtalk-icon-title">{t("auth.social.dingtalk")}</title>
        ...
        >
          <svg
            ...
            fill="currentColor"
            xmlns="http://www.w3.org/2000/svg"
            aria-labelledby="feishu-icon-title"
            role="img"
          >
            <title id="feishu-icon-title">{t("auth.social.feishu")}</title>

...
interface RecruiterInterviewCalendarProps {
...
export function RecruiterInterviewCalendar({
  interviews,
  candidates,
  onPreviewResume,
  view,
  ...
  date,
  onNavigate,
}: RecruiterInterviewCalendarProps) {
            ...
            <div className="text-sm text-muted-foreground flex items-center gap-2">
              ...
              <span className="truncate">
                ...
                <span className="font-medium text-foreground">
                  {event.resource.interview.interviewerName ||
                    t("common.unknown")}
                </span>
              </span>
            </div>

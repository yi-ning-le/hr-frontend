...
vi.mock("../AddCandidateDialog", () => ({
  AddCandidateDialog: () => <button data-testid="add-candidate-btn">Add Candidate</button>,
}));
...
vi.mock("@/components/ui/dropdown-menu", () => ({
  ...
  DropdownMenuCheckboxItem: ({ children, onCheckedChange, checked }: { children: React.ReactNode; onCheckedChange: (checked: boolean) => void; checked: boolean }) => (
    <div
      role="checkbox"
...
describe("CandidateToolbar", () => {
  ...
  it("renders correctly with default props", () => {
    ...
    expect(screen.getByPlaceholderText("recruitment.candidates.toolbar.searchPlaceholder")).toBeInTheDocument();
    expect(screen.getByText("recruitment.candidates.toolbar.statusFilter")).toBeInTheDocument();
  ...
  it("calls onSearchChange when input changes", () => {
    ...
    const searchInput = screen.getByPlaceholderText("recruitment.candidates.toolbar.searchPlaceholder");
  ...
  it("renders status filter badge when filters are active", () => {
    render(<CandidateToolbar {...defaultProps} statusFilter={["new", "interview"]} />);
  ...
  it("calls onStatusFilterChange when a status is toggled", () => {
    ...
    const newStatusOption = screen.getByText("recruitment.candidates.statusOptions.new");
